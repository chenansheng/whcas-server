...
class WhcasSettings(BaseSettings):
    """Admin Settings"""
    ...
    # Captcha
    CAPTCHA_LOGIN_REDIS_PREFIX: str = 'whcas:login:captcha'
...
@lru_cache
def get_whcas_settings() -> WhcasSettings:
    """获取 admin 配置"""
    return WhcasSettings()


whcas_settings = get_whcas_settings()
